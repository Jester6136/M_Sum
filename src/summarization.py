...
class M_Sum():
    def __init__(self,lang='vi'):
        pretrained = "NlpHUST/vibert4news-base-cased" if lang=='vi' else("bert-base-chinese" if lang=='ch' else ("DeepPavlov/rubert-base-cased" if lang=='ru' else 'bert-base-uncased'))
    ...
    def summary_url(self,paper_url, auto_selection=True):
